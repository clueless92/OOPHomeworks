package bg.softuni.polymorphism.exercises.pr02VehiclesExtention;

import bg.softuni.polymorphism.exercises.pr02VehiclesExtention.vehicles.Bus;
import bg.softuni.polymorphism.exercises.pr02VehiclesExtention.vehicles.Car;
import bg.softuni.polymorphism.exercises.pr02VehiclesExtention.vehicles.Truck;
import bg.softuni.polymorphism.exercises.pr02VehiclesExtention.vehicles.Vehicle;
    ...
    private static void ExecuteCommand(
        ...
        switch (action) {
            ...
            case "DriveEmpty":
                ...
                ((Bus)vehicle).driveEmpty(busDistance);
                break;
            default:
                break;
        }
